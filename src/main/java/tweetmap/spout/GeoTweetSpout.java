...
import tweetmap.utils.GeoTwitterListener;
...
public class GeoTweetSpout extends BaseRichSpout {
     ...
     */
    public GeoTweetSpout(String key, String secret, String token, String tokenSecret) {
        custkey = key;
        custsecret = secret;
        accesstoken = token;
    ...
    public void open(Map map, TopologyContext topologyContext, SpoutOutputCollector spoutOutputCollector) {
        ...
        double[][] boundingBox = {{-179, -80}, {179, 80}};
